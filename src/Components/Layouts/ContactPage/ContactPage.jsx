  ...
  return (
    <div className="pt-3 m-auto px-3 pb-5" style={{ maxWidth: "600px" }}>
      ...
      <div className="d-flex gap-2 align-items-center flex-wrap-reverse justify-content-center">
        ...
        >
          If there is something you are wondering about, feel free to send us a
          massage by our contact form below.{" "}
        </p>
        <Image
          src={contactImg}
          alt="Helpdesk picture"
          style={{ maxWidth: "200px", width: "100%", borderRadius: "100px" }}
        />
      </div>

      <Form onSubmit={handleSubmit(onSubmit)} className="pt-3 pb-5">
