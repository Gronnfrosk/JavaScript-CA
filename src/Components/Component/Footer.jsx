  ...
  return (
    <>
      <footer className="text-light bg-dark fs-6 w-100" data-bs-theme="dark">
        <div
          className="d-flex flex-wrap justify-content-between py-5 justify-content-end mx-auto gap-4"
        ...
        >
          <div className="d-flex flex-wrap justify-content-center gap-4">
            ...
            <div style={{ width: "200px" }}>
              <b>
                <u>Something Random:</u>
              </b>{" "}
              Quickly change the font-size of tedsadsaxt. While our heading
              classes apply font-size, font-weight, and line-height, these
              utilities only apply font-size. Sizing for these utilities matches
